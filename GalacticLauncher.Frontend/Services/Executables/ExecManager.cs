...
public interface IExecManager
{
    ...
    Task DownloadAsync(ExecInfo execInfo, IProgress<DownloadProgressData> progress, CancellationToken cancellationToken = default);
    ...
    IFileDecompressor fileDecompressor) : IExecManager
{
    ...
    public async Task DownloadAsync(ExecInfo execInfo, IProgress<DownloadProgressData> progress, CancellationToken cancellationToken = default)
    {
        if (IsDownloading(execInfo))
