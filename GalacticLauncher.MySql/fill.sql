...
(6, 4, 'v0.7.5','release','Fixed using correct array measurements when placing egg doodads',null,1,'2025-11-11','windows','https://github.com/teeworlds/teeworlds/releases/download/0.7.5/teeworlds-0.7.5-win64.zip','teeworlds-0.7.5-win64\\teeworlds.exe',null,'stable'),
(7, 4, 'v0.7.3.1','release','Fix platform-specific client libraries for Linux',null,1,'2025-11-11','windows','https://github.com/teeworlds/teeworlds/releases/download/0.7.3.1/teeworlds-0.7.3.1-win64.zip','teeworlds-0.7.3.1-win64\\teeworlds.exe',null,'stable'),
...
(11, 8, 'v2.1.1', 'release','',1,null,'2025-11-11','windows','https://github.com/juzzlin/DustRacing2D/releases/download/2.1.1/dustracing2d-2.1.1-windows-x86.zip','Dustracing.exe',null,'stable'),
(12,9, 'v1.1','release','',1,null,'2025-11-11','windows','https://github.com/fragglet/sdl-sopwith/releases/download/sdl-sopwith-2.9.0/sdl-sopwith-2.9.0-win64.zip','Sdl.exe',null,'stable');
